        ...
        <form className='flex flex-col mt-3' onSubmit={handleSubmit(onSubmit)}>
            ...
            {pathName === '/auctions/create' && (
                <>
                    ...
                    <div className='grid grid-cols-2 gap-3'>
                        <Input label='Reserve Price (enter 0 if no reserve)' name='reservedPrice' type='number' control={control} rules={{ required: 'Reserved price is required' }} />
                        <DateInput
            ...
            <div className='flex justify-between'>
                ...
                <Button isProcessing={isSubmitting} outline color='success' disabled={!isValid} type='submit'>Submit</Button>
            </div>
        </form>
    )
}
